        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
             ...
             <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item ">
                    ...
                    <asp:HyperLink ID="HyperLink5" NavigateUrl="Send.aspx" class="nav-link" runat="server">Sent</asp:HyperLink>
                  
                </li>
                <li class="nav-item">

                    <asp:HyperLink class="nav-link" NavigateUrl="Receive.aspx" ID="HyperLink6" runat="server">Receive</asp:HyperLink>
